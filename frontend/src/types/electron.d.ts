...
interface ElectronAPI {
  ...
  events: {
    ...
    onSessionArchived: (callback: (session: Session) => void) => () => void;
    ...
    onPanelActiveChanged: (callback: (data: { sessionId: string; panelId: string | null }) => void) => () => void;
    onProcessEnded: (callback: (data: { panelId: string; sessionId: string; exitCode: number | null }) => void) => () => void;
